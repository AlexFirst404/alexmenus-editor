...
<!-- Отдаём уже увеличенный PNG в его натуральном размере: GitHub вырезает CSS из markdown,
     поэтому image-rendering: pixelated тут не сработает, и единственный способ не получить мыло —
     чтобы браузеру нечего было масштабировать. 128 = 16x8, апскейл вшит в сам файл. -->
<img src="assets/logo-128.png" width="128" height="128" alt="AlexMenus" />
